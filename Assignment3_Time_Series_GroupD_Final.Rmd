...
```{r}
# Visualize correlations and relationships between sp_500 with selected economic indicators
...
```{r}
# Visualize correlations and relationships among major US stock indices
...
#Based on our diagnostic plot, the residuals seem to display a normal distribution.
